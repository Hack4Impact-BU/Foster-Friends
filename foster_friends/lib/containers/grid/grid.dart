...
Widget buildGrid(List<Map<String, dynamic>> posts, BuildContext context, Map<String, dynamic> user) => GridView.count(
    crossAxisCount: 3,
    scrollDirection: Axis.vertical,
    padding: const EdgeInsets.all(4),
    children: buildGridTileList(posts, context, user));

List<Widget> buildGridTileList(List<Map<String, dynamic>> posts, BuildContext context, Map<String, dynamic> user) {
  if (posts.length < 1) {
    return new List(0);
  }
        ...
        child: Container(
            ...
            child: FlatButton(
              ...
              onPressed: () async {
                ...
                // print(user);
                showDialog(context: context, builder: (BuildContext context) => PetProfile(posts[i], user));
              },
            )),
      ),
    );
