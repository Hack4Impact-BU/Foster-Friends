...
class UploadPetFormState extends State<UploadPetForm> {
  ...
  void _getCurrentLocation() async {
    ...
    setState(() {
      ...
      _locationMessageCoordinate = "Coordinate Get: " +
          petLocation1.toString() +
          ", " +
          petLocation2.toString();
    });
  }
  ...
  var maxWidthChild = SizedBox(
      child: Text("View Breed", maxLines: 1, overflow: TextOverflow.ellipsis));
  ...
  Widget build(BuildContext context) {
    ...
    if (petName.text != "" &&
        petAge.text != "" &&
        (petType.text != "" || otherTypeString.text != "") &&
      ...
      _onPressed = () async {
        ...
        petRef.setData({
          ...
          "type": petType.text == "" ? otherTypeString.text : petType.text,
    ...
    void _showDialogAdd(addnew) {
      if ((otherTypeString.text != "" || petType.text != "") && addnew != "") {
        showDialog(
            context: context,
            builder: (BuildContext context) {
              return AlertDialog(
        ...
        children: <Widget>[
          ...
          Row(mainAxisAlignment: MainAxisAlignment.start, children: <Widget>[
            Padding(
                ...
                child: DropdownButton(
                  hint:
                      Text('Select a Pet Type *'), // Not necessary for Option 1
          ...
          Row(mainAxisAlignment: MainAxisAlignment.start, children: <Widget>[
            Padding(
              padding: EdgeInsets.fromLTRB(0, 0, 0, 0),
              child: DropdownButton(
                hint: Text('Select Breed Type(s) *'),
                value: selectedBreedType.isEmpty
                    ? null
                    : _breedType.contains(selectedBreedType.last)
